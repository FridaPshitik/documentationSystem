...
export const AddProject = ({ toast }) => {
    ...
    const dataValidation = (data) => {
        const validationStatus = data.status && project.status === statuses.DONE && project.productionTime || project.status !== statuses.DONE
                    ...
                    <div className="card grid-container">
                        <div className="card item1">
                            <FloatLabel className="field">
                                <InputText className="w-full md:w-30rem field" id="name"
                                    value={project.name}
                                    onChange={(e) => {
                        ...
                        <div className="card item2">
                            <FloatLabel className="field">
                                <InputTextarea className="w-full md:w-30rem field" id="description"
                        ...
                        <div className="card item8">
                            <FloatLabel className="field">
                                <InputTextarea className="w-full md:w-30rem field" id="purpose"
                        ...
                        <div className="card item4">
                            <FloatLabel className="field" >
                                <Dropdown id="factorableType"
                                    value={project.factorableType}
                                    onChange={(e) => setProject((prevProject) => ({
                                        ...prevProject,
                        ...
                        <div className="card item5">
                            <FloatLabel className="field" >
                                <Dropdown inputid="dd-status"
                                    value={project.status}
                                    onChange={(e) => setProject((prevProject) => ({ ...prevProject, status: e.target.value }))}
                        ...
                        <div className="card item7">
                            {project.status === statuses.DONE &&
                                <FloatLabel className="field" >
                                    <Calendar inputid="dd-date"
                                        value={project.productionTime}
                                        onChange={(e) => setProject((prevProject) => ({
                                            ...prevProject,
                            ...
                            {project.status === statuses.DONE && formSubmitted && !project.productionTime && (
                                <Message severity="error" text=" הבחירה הינה חובה " />
                            )}
                        </div>
