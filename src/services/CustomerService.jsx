        ...
        return [
            {
                ...
                description: 'מערכת זו נועדה לספק מידע בצורה מרוכזת נגישה ונוחה על כל המערכות הקיימות בשלבי הפיתוח השונים,על מנת למנוע כפילויות ולאפשר מציאה קלה ונוחה של המערכת הרצויה. המערכת מרכזת את הנתונים עבור כל מערכת ומאפשרת חיפושים וסינונים שונים. עבור כל מערכת יוצגו גם פרטי איש קשר כדי לאפשר יצירת קשר ובדיקת האפשרות להשתמש במערכת הקיימת.',
                date: '',
                status: 'בפיתוח',
                type: "חיצוני",
                representative: {
